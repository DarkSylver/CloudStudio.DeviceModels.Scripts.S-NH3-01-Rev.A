...
# Parsing + Configuration Script – S-NH3-01 - Rev. A

This **Parsing + Configuration** script is designed for the **S-NH3-01** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – S-NH3-01 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **S-NH3-01** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
